...
<img class="btn-md" src="<?php echo e(asset('gambar/profil1.jpg')); ?>" alt="" style="border-radius:50%;" width="80%" height="80%">
</div>         
<div class="col-md-4 col-sm-4 text-center">
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mylat\resources\views//share/pengurus.blade.php ENDPATH**/ ?>